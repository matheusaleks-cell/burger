-- ENFORCE CUSTOMER BLOCK LOGIC
-- This function now checks if the customer is blocked before allowing an order.
...
BEGIN
    ...
    SELECT id, is_blocked INTO v_customer_id, v_is_blocked 
    ...
    IF v_is_blocked THEN
        RAISE EXCEPTION 'Este cliente está bloqueado e não pode realizar pedidos.';
    END IF;
